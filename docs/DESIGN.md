...
Estrategia: **Restrained** — neutros de taller + un solo acento. El naranja `#F2B705`
es el color del benteveo y el único color saturado; todo lo demás es hormigón,
papel y tinta.

| Variable | Valor | Uso canónico |
|---|---|---|
| `--color-primary` | `#F2B705` | Naranja Benteveo — CTA, links, activo (ÚNICO acento) |
